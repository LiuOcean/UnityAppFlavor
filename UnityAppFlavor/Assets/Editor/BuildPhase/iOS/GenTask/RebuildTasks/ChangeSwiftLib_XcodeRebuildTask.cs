...
{
    public class ChangeSwiftLib_XcodeRebuildTask : AXcodeRebuildTask
    {
        public override void Handle(PBXProject pbx_project, string path_to_built_project, string channel_name)
        {
            const string key = "ALWAYS_EMBED_SWIFT_STANDARD_LIBRARIES";
            ...
            foreach(var channel in _setting.channels)
            {
                ...
                pbx_project.SetBuildProperty(guid, key, "YES");
            }
        }
    }
}
